...
const HTTP_EDGE_IDENTITIES = {
  ...
  ACCESS_TO_PULSO_TOKEN: ["identity-service", "pulso-iris-service"],
  ACCESS_TO_SOFIA_TOKEN: ["identity-service", "agent-service"],
  ACCESS_TO_INTEGRATION_TOKEN: ["identity-service", "integration-service"],
  ACCESS_TO_KNOWLEDGE_TOKEN: ["identity-service", "knowledge-service"],
