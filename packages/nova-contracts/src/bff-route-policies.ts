...
export const NOVA_BFF_TENANT_ROUTE_POLICIES: readonly NovaBffTenantRoutePolicy[] = Object.freeze([
  ...
  novaTenantRoute("POST", "voice", "calls", "nova:write", ["admin", "supervisor"]),
  novaTenantRoute("POST", "voice", "campaigns", "nova:write", ["admin", "supervisor"]),
  novaTenantRoute("GET", "voice", "campaigns", "nova:read"),
  novaTenantRoute("GET", "voice", "campaigns/:campaignId/stats", "nova:read"),
  novaTenantRoute("POST", "voice", "campaigns/:campaignId/start", "nova:write", ["admin", "supervisor"]),
  novaTenantRoute("POST", "voice", "campaigns/:campaignId/pause", "nova:write", ["admin", "supervisor"]),
  novaTenantRoute("POST", "voice", "campaigns/:campaignId/stop", "nova:write", ["admin", "supervisor"]),
  novaTenantRoute("POST", "voice", "campaigns/:campaignId/cancel", "nova:write", ["admin", "supervisor"]),
