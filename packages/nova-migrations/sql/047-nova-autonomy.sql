-- NOVA product autonomy (ADR-0003 / ADR-0006).
-- Schemas own their data. tenant_id is an opaque logical identifier (no FKs to platform.tenants).
-- The NOVA database bootstrap creates roles before this provider-owned migrator runs.
...
-- Product catalog provisioning belongs to the neutral platform plane.
-- NOVA migrations intentionally do not write platform-owned tables.
