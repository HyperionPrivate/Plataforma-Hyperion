...
Module name for projections is **`analytics`** (not `analytics_projection`).
...
| campaign.enrolled | pilot-core.campaigns | analytics | internal |
| contact.attempt.requested | pilot-core.orchestration | analytics | internal |
| call.requested | pilot-core.orchestration | (dialer via HTTP, not bus) | internal |
| call.completed | pilot-core.orchestration | crm, analytics | internal |
...
| handoff.created | handoff-liwa | pilot-core, analytics | internal |
...
| core.outcome.recorded | pilot-core.core_adapter | crm, analytics | internal |
