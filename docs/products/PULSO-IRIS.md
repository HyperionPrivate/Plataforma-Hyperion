...
| PUL-211 | SOFÍA debe operar como contexto técnico autónomo con readiness, trabajos, inbox/outbox y acceso a otros dominios solo mediante contratos propietarios. | Parcial: el runtime current usa el marker local y contratos owner-owned; DEBT-027 mantiene los grants del marker global hasta un rehearsal N−1 real por digest.        |
