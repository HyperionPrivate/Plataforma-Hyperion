...
app = FastAPI(
    title="Coopfuturo analytics",
    version="0.1.0-stub",
    description="Proyecciones de lectura para BI. No escribe CRM.",
)
...
@app.api_route("/kpis/pilot", methods=["GET", "POST", "PUT", "PATCH"])
def business_stub(
    response: Response,
