...
app = FastAPI(
    title="Coopfuturo documents",
    version="0.1.0-stub",
    description="Validación básica de orden de matrícula / docs.",
)
...
@app.api_route("/documents", methods=["GET", "POST", "PUT", "PATCH"])
def business_stub(
    response: Response,
    ...
    return JSONResponse(
        ...
        content={
            ...
            "path": "/documents",
            "summary": "Recibe metadatos de PDF (stub).",
