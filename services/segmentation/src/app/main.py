...
app = FastAPI(
    title="Coopfuturo segmentation",
    version="0.1.0-stub",
    description="Scoring y priorización. No despacha llamadas.",
)
...
@app.api_route("/score", methods=["GET", "POST", "PUT", "PATCH"])
def business_stub(
    response: Response,
    ...
    return JSONResponse(
        ...
        content={
            ...
            "path": "/score",
            "summary": "Calcula score de propensión (stub).",
