...
import { productLineLabel, type CampaignRow } from "./types.js";
...
export function NovaCampaignsTab({
  ...
  const [scriptNote, setScriptNote] = useState("Saludo personalizado → propuesta de valor → siguiente acción.");
      ...
      <Card>
        ...
        {step === 0 ? (
          <div className="col" style={{ gap: 12 }}>
            ...
            {flowIds.length === 0 ? (
              <EmptyState label="Este tenant todavía no tiene flujos configurados. Créalo en Configuración antes de iniciar una campaña." />
            ) : (
              <div className="row" style={{ gap: 8, flexWrap: "wrap" }} aria-label="Flujos configurados del tenant">
                {flowIds.map((id) => (
                  <button
                    key={id}
                    type="button"
          ...
          <div className="col" style={{ gap: 8 }}>
            ...
            <div className="row" style={{ gap: 8, flexWrap: "wrap" }}>
              <button
                className="btn"
                type="button"
                disabled={!canWriteOps || busy || !flow}
              ...
              <button
                ...
                type="button"
                disabled={!canWriteOps || busy || !name.trim() || !flow}
